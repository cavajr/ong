...
class ProjetoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink(_t('New'), new TAction(['ProjetoForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['ProjetoForm', 'onEdit'], ['id'=>'{id}', 'register_state' => 'false']);

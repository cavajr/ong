...
class EstadoCivilList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $this->form->addActionLink(_t('New'), new TAction(['EstadoCivilForm', 'onEdit'], ['register_state' => 'false']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['EstadoCivilForm', 'onEdit'], ['id'=>'{id}', 'register_state' => 'false']);
